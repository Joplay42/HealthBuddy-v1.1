...
const RecipeFoodItemCard = ({
  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-center sm:justify-between gap-6 md:gap-4 py-5 border-neutral-300 dark:border-white/10 border-t animate-fade-in">
      ...
      {/** Add button */}
      <button
        className="disabled:opacity-50 bg-black dark:bg-lime text-white dark:text-ink-950 rounded-xl text-2xl h-10 lg:h-16 w-full lg:w-12 col-span-2 md:col-span-3 lg:col-span-1 lg:justify-self-end"
