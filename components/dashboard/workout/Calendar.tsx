			...
			<div className='flex items-center justify-between mb-5'>
				<div className='flex items-center gap-2'>
					...
					<HelpBubble
						id='workout-planning'
						placement='right'
						content="Your weekly schedule. Tap a day to view its workout, or use the arrows to look ahead. Use the Change button to swap your full plan."
					/>
				</div>
				<button
				...
				<button
					data-tour='create-plan-btn-mobile'
