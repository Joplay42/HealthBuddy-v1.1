...
const Weight = () => {
  ...
  return (
    <div
      data-tour="home-weight"
      className="col-span-2 w-full h-full animate-fade-in"
    >
      <div className="flex items-center justify-between pb-5 gap-3">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <HelpBubble
            id="home-weight"
            placement="right"
            content="Your weight trend with a streak counter. Log every weigh-in to keep the streak and the projection accurate."
          />
          {streak.current > 0 && (
