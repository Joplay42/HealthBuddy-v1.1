			...
			<div className='w-full max-h-full'>
				<div className='md:flex space-y-2 md:space-y-0 md:space-x-4'>
					<div className='flex flex-col w-full gap-y-2'>
						...
						<label className='font-bold dark:text-bone'>Email</label>
						{/** Display the input */}
						<input
					...
					<div className='flex flex-col w-full gap-y-2'>
						{/** Display the label above */}
						<label className='font-bold dark:text-bone'>Password</label>
						{/** Display the input */}
						<input
							className='border-black rounded-xl w-full'
							type='password'
				...
				<div className='relative'>
					...
					<div className='p-4 md:p-5 text-center'>
						...
						<button
							className='items-center gap-2 justify-center py-4 px-3 rounded-xl hover:opacity-75 hover:transition ease-in-out duration-300 bg-red-500 text-white disabled:opacity-60 inline-flex mx-3'
