  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-center sm:justify-between gap-6 md:gap-4 py-5 border-neutral-300 border-t animate-fade-in">
      ...
      <div className="flex items-center space-x-4">
        <div className="w-16 h-16 border-[12px] border-gray-200 dark:border-ink-800 rounded-full animate-pulse"></div>
        <div className="h-6 w-20 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
      </div>
      {/** Food nutrient informations */}
      <div className="flex items-center space-x-10 justify-self-end sm:space-x-4">
        <div className="text-center space-y-2">
          <div className="h-6 w-16 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
          <div className="h-6 w-10 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
        </div>
        <div className="text-center space-y-2">
          <div className="h-6 w-16 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
      ...
      {/** Food qty input */}
      <div className="flex space-x-4 lg:items-center space-y-2">
        <div className="h-6 w-10 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
        <div className="h-10 w-20 bg-gray-200 dark:bg-ink-800 animate-pulse rounded"></div>
      </div>
      {/** Add button */}
      <div className="bg-gray-200 dark:bg-ink-800 animate-pulse rounded-xl text-2xl h-10 lg:h-16 w-full lg:w-12 col-span-2 sm:col-span-3 lg:col-span-1 lg:justify-self-end"></div>
    </div>
  );
};
