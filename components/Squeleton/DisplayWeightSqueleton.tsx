			...
			<div className='relative h-full w-full'>
				...
				{yTicks.map((_, rowIndex) => (
					...
					>
						...
						<div className='w-8 h-6 bg-neutral-300 dark:bg-ink-700 rounded-md mr-2' />
						{/* Grid line */}
						<div className='flex-1 h-px bg-neutral-300 dark:bg-ink-800' />
					</div>
				))}
				...
				{xTicks.map((_, colIndex) => (
					...
					>
						{/* Grid line */}
						<div className='w-px flex-1 bg-neutral-300 dark:bg-ink-800' />
						{/* X-axis tick placeholder */}
						<div className='w-8 h-6 bg-neutral-300 dark:bg-ink-700 rounded-md mt-2' />
					</div>
				))}
			</div>
		</div>
